...
/**
 * An OnPush component shows a form it does not own, and that form changes without any event
 * inside the component. This marks it for check when the form emits a value or status change,
 ...
 *
 * Call it from the constructor with the form as a signal: an input, or FormFactoryService.root.
 */
